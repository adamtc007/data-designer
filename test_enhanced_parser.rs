use data_designer::{transpile_dsl_to_enhanced_rules, EnhancedRulesEngine, LiteralValue};
...
fn main() {
    ...
    // Test 8: Attribute resolution at runtime
...
where
    F: Fn(&EnhancedRulesEngine) -> Option<data_designer::DerivationResult>
{
