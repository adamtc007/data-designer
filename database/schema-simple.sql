-- Data Designer Database Schema (without pgvector for now)
-- Simple version for PostgreSQL 14
...
('Client', 'risk_score', 'Number', 'INTEGER', 'i32', 'Calculated risk score'),
('Client', 'email_valid', 'Boolean', 'BOOLEAN', 'bool', 'Email validation result'),
('Client', 'kyc_completion_percentage', 'Number', 'INTEGER', 'i32', 'KYC completion percentage'),
('Client', 'enhanced_dd_required', 'Boolean', 'BOOLEAN', 'bool', 'Enhanced due diligence flag'),
('Client', 'service_tier', 'Enum', 'VARCHAR(20)', 'ServiceTier', 'Client service tier classification');

UPDATE derived_attributes SET domain_id = (SELECT id FROM data_domains WHERE domain_name = 'ServiceTier')
WHERE attribute_name = 'service_tier';