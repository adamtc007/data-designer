        ...
        let client_entity = Entity {
            ...
            attributes: vec![
                Attribute {
                    ...
                    sql_type: Some("VARCHAR(50) PRIMARY KEY".to_string()),
                    rust_type: Some("String".to_string()),
                    format_mask: Some("XXX-999".to_string()),
                    min_length: Some(1),
                    max_length: Some(50),
                    min_value: None,
                    max_value: None,
                ...
                Attribute {
                    ...
                    sql_type: Some("VARCHAR(255) NOT NULL".to_string()),
                    rust_type: Some("String".to_string()),
                    format_mask: None,
                    min_length: Some(1),
                    max_length: Some(255),
                ...
                Attribute {
                    ...
                    sql_type: Some("CHAR(20)".to_string()),
                    rust_type: Some("String".to_string()),
                    format_mask: Some("XXXXXXXXXXXXXXXXXXXX".to_string()),
                    min_length: Some(20),
                    max_length: Some(20),
                    min_value: None,
                    max_value: None,
                    pattern: Some(r"^[A-Z0-9]{20}$".to_string()),
                },
                Attribute {
                    ...
                    sql_type: Some("VARCHAR(255) NOT NULL".to_string()),
                    rust_type: Some("String".to_string()),
                    format_mask: Some("xxx@xxx.xxx".to_string()),
                    min_length: Some(5),
                    max_length: Some(255),
                    min_value: None,
                    max_value: None,
                ...
                Attribute {
                    ...
                    data_type: DataType::Enum(vec!["LOW".to_string(), "MEDIUM".to_string(), "HIGH".to_string()]),
                    ...
                    sql_type: Some("ENUM('LOW', 'MEDIUM', 'HIGH') NOT NULL".to_string()),
                    rust_type: Some("RiskLevel".to_string()),
                    format_mask: None,
                    min_length: None,
                    max_length: None,
                    min_value: None,
                ...
                Attribute {
                    ...
                    domain: None,
                    examples: vec!["1000000.00".to_string(), "50000000.00".to_string()],
                    sql_type: Some("DECIMAL(18,2)".to_string()),
                    rust_type: Some("rust_decimal::Decimal".to_string()),
                    format_mask: Some("$999,999,999,999.99".to_string()),
                    min_length: None,
                    max_length: None,
                    min_value: Some("0".to_string()),
                    max_value: Some("999999999999999.99".to_string()),
                    pattern: None,
                },
                Attribute {
                    name: "kyc_status".to_string(),
                    data_type: DataType::Enum(vec!["PENDING".to_string(), "APPROVED".to_string(), "REJECTED".to_string()]),
                    ...
                    sql_type: Some("ENUM('PENDING', 'APPROVED', 'REJECTED') NOT NULL".to_string()),
                    rust_type: Some("KycStatus".to_string()),
                    format_mask: None,
                    min_length: None,
                    max_length: None,
                    min_value: None,
                ...
                Attribute {
                    ...
                    sql_type: Some("BOOLEAN NOT NULL DEFAULT FALSE".to_string()),
                    rust_type: Some("bool".to_string()),
                    format_mask: None,
                    min_length: None,
                    max_length: None,
                    min_value: None,
