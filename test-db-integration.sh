...
echo ""
echo "To run the IDE with database support:"
echo "1. cd src-tauri"
echo "2. cargo tauri dev"
echo ""
echo "The IDE will automatically:"
echo "- Load rules from PostgreSQL"
echo "- Generate embeddings for semantic search"
echo "- Find similar rules using cosine similarity"
echo "- Save rule updates to the database"